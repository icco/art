...
// Stubs filled in by later commits. 501 makes them visible as "not yet
// implemented" rather than 404.

func (h *Handlers) OAuthStart(w http.ResponseWriter, r *http.Request)           { notImpl(w) }
func (h *Handlers) OAuthCallback(w http.ResponseWriter, r *http.Request)        { notImpl(w) }
...
func (h *Handlers) SyncRun(w http.ResponseWriter, r *http.Request)              { notImpl(w) }
