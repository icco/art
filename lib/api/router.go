...
func NewRouter(d Deps) http.Handler {
	...
	r.Group(func(r chi.Router) {
		...
		r.Route("/working-hours", func(r chi.Router) {
			r.Get("/", d.H.WorkingHoursList)
			r.Put("/", d.H.WorkingHoursReplace)
			r.Patch("/{kind}/{day}", d.H.WorkingHoursPatchDay)
		})
		r.Get("/settings", d.H.SettingsGet)
		r.Put("/settings", d.H.SettingsUpdate)
